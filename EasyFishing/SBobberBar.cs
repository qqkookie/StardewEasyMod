...
namespace EasyFishing
{
    internal class SBobberBar : BobberBar
    {
        ...
        public float OldReelSpeed { get; set; }
        ...
        /// <summary>bobber bar is short green bar that moves up and down</summary>
        ...
        /// <summary>Bobber is the fish that moves up and down</summary>
        ...
        /// <summary>Whether or not a treasure chest appears</summary>
        ...
        public bool fadeOut
        {
            ...
            set { SBobberBar.GetBaseFieldInfo("fadeOut").SetValue(this.BaseBobberBar, value); }
        }
